    ...
    public static class DataContextSeed
    {
        public static async Task SeedAsync(DataContext context)
        {
            try
            {
                ...
                {
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Отличный фильм, рекомендую всем!", Rating = 5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Наивное кино, не стоит тратить время", Rating = 2 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Прекрасная игра актеров, захватывающий сюжет", Rating = 4.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм оставил равнодушным, ничего особенного", Rating = 2.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Я в восторге! Лучший фильм всех времен!", Rating = 5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Сюжет предсказуем, но смотреть было не скучно", Rating = 3.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Отстой, полный бред!", Rating = 1 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Захватывающий экшен, один из лучших фильмов в этом жанре", Rating = 4 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Понравился финал, неожиданный поворот событий", Rating = 4.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Нудный фильм, сюжет не цепляет", Rating = 2 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Отличное кино, смотрела на одном дыхании", Rating = 5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Глубокий смысл, много мыслей после просмотра", Rating = 4 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Потрясающая игра актеров, очень трогательная история", Rating = 4.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм вызвал у меня множество эмоций, рекомендую!", Rating = 5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Увлекательный сюжет, непредсказуемый повороты", Rating = 4.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм сомнительного качества, жаль потраченного времени", Rating = 2 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Очень понравился, захватывающая драма", Rating = 4 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм, который меня расстроил, ожидал большего", Rating = 2.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Смешно и трогательно, отличная комедия", Rating = 4 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Наигранно и нереалистично, не понравилось", Rating = 2 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм, который зацепил и заставил задуматься", Rating = 4.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Не рекомендую, пустая трата времени", Rating = 1.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Интересный сюжет, рекомендую для просмотра", Rating = 4 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм с глубоким смыслом, отличная работа режиссера", Rating = 4.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Идеальный фильм, все балансирует на отличном уровне", Rating = 5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Необычная история, захватывающая драма", Rating = 4.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм полный магии, смотрела с удовольствием", Rating = 5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Сюжет неинтересный, фильм не зацепил", Rating = 2 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм вызвал бурю эмоций, я в восторге!", Rating = 5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Захватывающая история, отличное исполнение", Rating = 4.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Плохой фильм, разочарована", Rating = 1.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Интригующий сюжет, качественный фильм", Rating = 4 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм, который вызвал массу эмоций, настоящее произведение искусства", Rating = 5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Сюжет непредсказуем, переживала за главных героев", Rating = 4 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Расстроенный фильм, не понял его смысла", Rating = 1.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Отличная атмосфера, красивое кино", Rating = 4.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм, который меня поразил, не забуду никогда", Rating = 5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Сюжет нудноват, но фильм в целом хороший", Rating = 3 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм вызвал глубокие эмоции, просто потрясающе", Rating = 5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Захватывающий фильм, смотрел на одном дыхании", Rating = 4.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Пустая трата времени, не рекомендую", Rating = 2 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм, который зацепил с первых минут", Rating = 4.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Не понравился фильм, ничего особенного", Rating = 2.5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Качественное кино, прекрасно отыгранные роли", Rating = 4 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Идеальный фильм, захватывающая драма", Rating = 5 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм с интересным сюжетом, но не зацепил", Rating = 3 },
                    new Review { movie = movies[0], user = context.Users.Last(), Text = "Фильм, который вызвал у меня множество эмоций!", Rating = 5 }
                });
